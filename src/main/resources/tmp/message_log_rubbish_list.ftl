	  ...
	  <div class="pageb_universal">
		...
		<div class="pers-r-content1">
			<div class="p-posts-title">
				<div class="posts-off"><a href="${base}/space/message.html">收信箱</a></div>
				<div class="posts-on">垃圾箱</div>
			</div>
			<div class="p-posts-box">				
				<div class="pers-r-inf">
					<div class="space_inf-qk">
						<ol class="color_fff"><a href="javascript:deleteMess();">永久删除</a></ol>
					</div>
			...
			<input name="isRub" type="hidden" value="${(isRub)!}">		
						...
						<ul>
							...
							<li>
							  <span class="p-posts-list-zt color_680"><input type="checkbox" name="ids"  id="message_id" value="${message.id!}" onclick="javascript:resetAll()">
								<#if "${(message.type)!}"="1">
								<a href="javascript:" onclick="intoOne('${message.id}','${message.formId}');">${(message.formTitle)!}</a></span>
				...
				<div class="publicad_fy">
					<div class="viciao">
						...
						<#else>
							<a href='${base}/space/message_rubbish_p_${page.previousPage!}.html'> 上一页</a>
						</#if>
							...
							<#if page.totalPage gt 7>
								...
								<#list 1..page.currentPage as i>
									...
									<#else>
										<a href="${base}/space/message_rubbish_p_${i}.html">${i}</a></li>
									</#if>
								</#list>
								<#else>
									<#if page.currentPage==1>
									...
									<#else>
									<a href="${base}/space/message_rubbish_p_1.html" >1</a>
									</#if>
									<a>...</a>
									<#list page.currentPage-2..page.currentPage as i>
										<#if page.currentPage==i>
											<span class="current">${i}</span>
										<#else>
											<a href="${base}/space/message_rubbish_p_${i}.html">${i}</a>
										</#if>
									</#list>
								</#if>
								...
								<#else>
									...
									<#else>
										<a href="${base}/space/message_rubbish_p_${page.totalPage!}.html" >${page.totalPage!}</a>
									</#if>
								</#if>
							<#else>
								...
								<#else>
									<a href='${base}/space/message_rubbish_p_${page.nextPage!}.html'> 下一页</a>
								</#if>
								共${(pageNum)!}条记录
						</#if>
						</div>
